<template >
  <div style="width:100%;height:178vw;background-color:#f1f1f1">
    <!-- 优惠券 -->
    <mt-header
      title="无效券"
    ...
    <div class="ebody">
      <div class="eb_head" style="position: fixed; z-index: 4">
        <p class="zuo">已过期优惠券</p>
      </div>

               <div class="kk" style="margin-top: 17vw;" v-if="data">
                 <div class="box">
                <div class="kuang1" v-for="(item, index) in data1" :key="index">
          <div class="zuo1" style="margin-top: 1.1rem">
          ...
          <div class="you1" style="display: flex; position: relative">
            <div class="you2">
              ...
              <span style="color: rgb(161, 159, 159); padding-top: 0.4rem"
                >有效期至{{ item.yhq_time | moment }}</span
              >
...
.kuang1 {
  ...
  // border: 0.0625rem solid rgb(234, 230, 230);
  display: flex;
  position: relative;
  overflow: hidden;
  border-radius: 1.2vw;
  box-shadow: 0.125rem 0.125rem 0.125rem rgb(230, 230, 230);
  margin-top: 1rem;
  margin-left: 0.5rem;
}
.zuo1 {
  ...
  border-right: 0.125rem dashed rgb(163, 154, 154);
  text-align: center;
  margin-top: 0.5rem;
}
.you1 {
