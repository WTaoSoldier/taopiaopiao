<template>
  <div>
    <mt-header title="影片详情" fixed style="margin-bottom:1rem">
      <mt-button slot="left" icon="back" @click="btn4"></mt-button>
      <mt-button icon="more" slot="right"></mt-button>
    </mt-header>
    <!-- 徐高广-每周必抢礼包页 -->
    <div class="head-image" style="margin-top:1rem">
      <img src="/wljlogo/y1.jpg" />
      <img  src="/img/xggpic/y2.png" />
      <img
        src="/wljlogo/y3.png"
